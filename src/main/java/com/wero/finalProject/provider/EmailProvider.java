...
public class EmailProvider {
    ...
    private String getCertificationMessage(String certificationNumber){
        ...
        certificationMessage+="<p style=\"text-align: center; font-size: 24px; color: #007bff;\"><strong>VERIFICATION_CODE</strong></p>";
        ...
        certificationMessage+="<p style=\"text-align: center; color: #666; font-size: 16px;\">감사합니다,<br> For you and For us WeRo (주)CKO네트웍스</p>";
